...
public class BoardDAOTest {
	...
	public void testGetBoardContent() throws Exception{
		...
		logger.info("\n Board List \n");
		if (boardDAO != null) {
			logger.info("글 번호 : " + boardVO.getBid());
			logger.info("글 제목 : " + boardVO.getTitle());
			logger.info("글 내용 : " + boardVO.getContent());
			logger.info("글 태그 : " + boardVO.getTag());
			logger.info("조회 수 : " + boardVO.getView_cnt());
